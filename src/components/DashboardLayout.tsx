                    ...
                    <DropdownMenuTrigger asChild>
                        <Button variant="ghost" className="w-full justify-start px-2">
                            <Avatar className="h-8 w-8 mr-2">
                                ...
                                <AvatarFallback>{getInitials(`${user.firstName} ${user.lastName}`)}</AvatarFallback> {/* Placeholder Initials */}
                            </Avatar>
                            <span
                                className="truncate">{user.firstName} {user.lastName}</span> {/* Placeholder Name */}
                        </Button>
                    </DropdownMenuTrigger>
